...
class Chan_Strategy(Template):
    ...
    def __init__(self, engine, strategy_name, vt_symbol, setting , BacktraderBuy , BacktraderSell):
        """
        从1分钟->5->30->1d
        先做一个级别，之后再做其他的级别
        """
        ...
        self.BacktraderBuy = BacktraderBuy
        self.BacktraderSell = BacktraderSell
